...
cs = cross_sections.CompositeCrossSection(
    [(0.0, cross_sections.TabulatedCrossSection, ("CRP2_TALYS",)), (0.14, cross_sections.SophiaSuperposition, ())]
)
    ...
    def test_propagation(self):
        ...
        solver.add_source_class(
            AugerFitSource(
                prince_run_talys,
                norm=1e-50,
                params={101: (0.96, 10**9.68, 20.0), 402: (0.96, 10**9.68, 50.0), 1407: (0.96, 10**9.68, 30.0)},
            )
        )
